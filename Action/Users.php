 ...
 * Action Users 
 * 
 * This is the module that is used to create new users and also list all users on
 * the system. It receives a GET and a POST.
 * 
...
class Action_Users extends Frapi_Action implements Frapi_Action_Interface
{
    ...
    {
        $model = new Model_OSI_Users();
        $this->data = $model->getAll();

        throw new Frapi_Error('OSIDAYS');
        return $this->toArray();
    }
